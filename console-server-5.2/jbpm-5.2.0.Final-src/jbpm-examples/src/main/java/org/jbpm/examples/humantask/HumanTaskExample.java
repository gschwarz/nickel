...
public class HumanTaskExample {
	...
	public static final void main(String[] args) {
		try {
			...
			groups.add("sales");
			taskClient.getTasksAssignedAsPotentialOwner("sales-rep", groups, "es_CL", taskSummaryHandler);
			...
			taskClient.getTasksAssignedAsPotentialOwner("krisv", "es_CL", taskSummaryHandler);
			...
			groups.add("PM");
			taskClient.getTasksAssignedAsPotentialOwner("john", groups, "es_CL", taskSummaryHandler);
			...
			taskSummaryHandler = new BlockingTaskSummaryResponseHandler();
			taskClient.getTasksAssignedAsPotentialOwner("sales-rep", "es_CL", taskSummaryHandler);
