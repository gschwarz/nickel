...
public class EvaluationExample2 {
	...
	public static final void main(String[] args) {
		try {
			...
			groups.add("HR");
			taskClient.getTasksAssignedAsPotentialOwner("mary", groups, "es_CL", taskSummaryHandler);
			...
			taskSummaryHandler = new BlockingTaskSummaryResponseHandler();
			taskClient.getTasksAssignedAsPotentialOwner("mary", "es_CL", taskSummaryHandler);
