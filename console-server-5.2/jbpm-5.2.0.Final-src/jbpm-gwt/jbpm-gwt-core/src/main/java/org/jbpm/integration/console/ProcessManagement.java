...
public class ProcessManagement implements org.jboss.bpm.console.server.integration.ProcessManagement {
	...
	private final static Logger log = Logger.getLogger(ProcessManagement.class.getName()); 
	...
	public ProcessDefinitionRef getProcessDefinition(String definitionId) {
		log.log(Level.INFO, "[ProcessManagement]:: getProcessDefinition  :" +definitionId );
...
//		return result;
		...
		return PersistProcessEventManager.getInstanceByProcessId(definitionId);
	}

	public ProcessInstanceRef newInstance(String definitionId) {
		log.log(Level.INFO, "[ProcessManagement]:: newInstance :" +definitionId );
	...
	public ProcessInstanceRef newInstance(String definitionId, Map<String, Object> processVars) {
		log.log(Level.INFO, "[ProcessManagement]:: newInstance Params :" +definitionId  + "Params  : " + processVars);
