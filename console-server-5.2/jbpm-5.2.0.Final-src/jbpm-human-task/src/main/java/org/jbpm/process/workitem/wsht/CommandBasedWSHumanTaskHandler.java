...
public class CommandBasedWSHumanTaskHandler implements WorkItemHandler {
	...
	private final static Logger log = Logger.getLogger(CommandBasedWSHumanTaskHandler.class.getName()); 
	...
	public void connect() {
		log.log(Level.INFO,"[CommandBasedWSHumanTaskHandler] :: Connect "+ client);
		client=null;
		if (client == null) {
			...
			if (!connected) {
				log.log(Level.INFO,"[CommandBasedWSHumanTaskHandler] :: Error conexion ");
	...
	public void executeWorkItem(WorkItem workItem, WorkItemManager manager) {
		...
		if (taskName != null) {
			...
			names.add(new I18NText("es_CL", taskName));
			task.setNames(names);
		}
		String name = (String) workItem.getParameter("Name");
		String comment = (String) workItem.getParameter("Comment");
		log.log(Level.INFO,"[CommandBasedWSHumanTaskHandler] :: ");
		...
		if (comment != null) {
			...
			descriptions.add(new I18NText("es_CL", comment));
			task.setDescriptions(descriptions);
			List<I18NText> subjects = new ArrayList<I18NText>();
			subjects.add(new I18NText("es_CL", comment));
