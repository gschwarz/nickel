...
public abstract class WSHumanTaskHandlerBaseAsyncTest extends BaseTest {
    ...
    public void FIXME_testTask() throws Exception {
        ...
        client.getTasksAssignedAsPotentialOwner("Darth Vader", "es_CL", responseHandler);
    ...
    public void FIXME_testTaskMultipleActors() throws Exception {
        ...
        BlockingTaskSummaryResponseHandler responseHandler = new BlockingTaskSummaryResponseHandler();
        getClient().getTasksAssignedAsPotentialOwner("Darth Vader", "es_CL", responseHandler);
        List<TaskSummary> tasks = responseHandler.getResults();
        assertEquals(1, tasks.size());
        TaskSummary task = tasks.get(0);
        assertEquals("TaskName", task.getName());
    ...
    public void testTaskGroupActors() throws Exception {
        ...
        getClient().getTasksAssignedAsPotentialOwner(null, groupIds, "es_CL", responseHandler);
        List<TaskSummary> tasks = responseHandler.getResults();
        assertEquals(1, tasks.size());
    ...
    public void FIXME_testTaskSingleAndGroupActors() throws Exception {
        ...
        List<String> groupIds = new ArrayList<String>();
        groupIds.add("Crusaders");
        getClient().getTasksAssignedAsPotentialOwner("Darth Vader", groupIds, "es_CL", responseHandler);
        List<TaskSummary> tasks = responseHandler.getResults();
    ...
    public void TODOtestOnAllSubTasksEndParentEndStrategy() throws Exception {
        ...
        responseHandler = new BlockingTaskSummaryResponseHandler();
        getClient().getSubTasksAssignedAsPotentialOwner(parentTask.getId(), "Darth Vader", "es_CL", responseHandler);
