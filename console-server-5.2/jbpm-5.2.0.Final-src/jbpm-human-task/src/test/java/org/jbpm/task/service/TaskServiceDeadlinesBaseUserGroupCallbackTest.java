...
public abstract class TaskServiceDeadlinesBaseUserGroupCallbackTest extends BaseTestNoUserGroupSetup {
    ...
    public void testDelayedEmailNotificationOnDeadline() throws Exception {
        ...
        userInfo.getLanguages().put(  users.get("tony"), "es_CL" );
        userInfo.getLanguages().put(  users.get("darth"), "es_CL" );
    ...
    public void testDelayedReassignmentOnDeadline() throws Exception {
        ...
        userInfo.getLanguages().put(  users.get("tony"), "es_CL" );
        userInfo.getLanguages().put(  users.get("luke"), "es_CL" );
        userInfo.getLanguages().put(  users.get("bobba"), "es_CL" );
        userInfo.getLanguages().put(  users.get("jabba"), "es_CL" );
        notificationHandler.setUserInfo( userInfo );    
