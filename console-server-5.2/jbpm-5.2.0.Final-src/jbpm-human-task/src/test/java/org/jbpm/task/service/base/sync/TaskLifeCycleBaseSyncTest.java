...
//        str += "descriptions = [ new I18NText( 'es_CL', 'This is my description')], ";
//        str += "subjects = [ new I18NText( 'es_CL', 'This is my subject')], ";
        str += "names = [ new I18NText( 'es_CL', 'This is my task name')] })";
        ...
        List<TaskSummary> tasks = client.getTasksAssignedAsPotentialOwner(users.get("bobba").getId(), "es_CL");
        assertEquals(1, tasks.size());
        assertEquals(Status.Reserved, tasks.get(0).getStatus());

        client.start(taskId, users.get("bobba").getId());

        tasks = client.getTasksAssignedAsPotentialOwner(users.get("bobba").getId(), "es_CL");
        assertEquals(1, tasks.size());
