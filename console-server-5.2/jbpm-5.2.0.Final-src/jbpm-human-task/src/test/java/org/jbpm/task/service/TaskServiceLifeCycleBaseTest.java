...
public abstract class TaskServiceLifeCycleBaseTest extends BaseTest {
    ...
    public void testRemoveNotInRecipientList() {
        ...
        client.getTasksAssignedAsRecipient(users.get("jabba").getId(), "es_CL", responseHandler);
        ...
        client.getTasksAssignedAsPotentialOwner(users.get("jabba").getId(), "es_CL", responseHandler);
