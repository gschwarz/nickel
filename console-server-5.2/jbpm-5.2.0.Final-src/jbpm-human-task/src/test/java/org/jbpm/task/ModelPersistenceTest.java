...
public class ModelPersistenceTest extends BaseTest {
    ...
    public void testfullHibernateRoundtripWithAdditionalMVELCheck() throws Exception {
        ...
        subjects.add( new I18NText( "es_CL", "This is my start notification subject" ) );
        subjects.add( new I18NText( "en-DK", "Das ist mein start anmeldung Thema" ) );

        descriptions.add( new I18NText( "es_CL", "This is my start notification description" ) );
        ...
        docs.add( new I18NText( "es_CL", "Start Reassignment documentation" ) );
        ...
        subjects.add( new I18NText( "es_CL", "This is my end notification subject" ) );
        subjects.add( new I18NText( "en-DK", "Das ist mein ende anmeldung Thema" ) );

        descriptions.add( new I18NText( "es_CL", "This is my end notification description" ) );
        ...
        docs = new ArrayList<I18NText>();
        reassignment.setDocumentation( docs );
        docs.add( new I18NText( "es_CL", "End Reassignment documentation" ) );
