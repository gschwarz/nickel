...
public abstract class WSHumanTaskHandlerBaseSyncTest extends BaseTest {
    ...
    public void FIXME_testTask() throws Exception {
        ...
        List<TaskSummary> tasks = client.getTasksAssignedAsPotentialOwner("Darth Vader", "es_CL");
    ...
    public void FIXME_testTaskMultipleActors() throws Exception {
        ...
        List<TaskSummary> tasks = getClient().getTasksAssignedAsPotentialOwner("Darth Vader", "es_CL");
        assertEquals(1, tasks.size());
        TaskSummary task = tasks.get(0);
        assertEquals("TaskName", task.getName());
        assertEquals(10, task.getPriority());
    ...
    public void testTaskGroupActors() throws Exception {
        ...
        List<TaskSummary> tasks = getClient().getTasksAssignedAsPotentialOwner(null, groupIds, "es_CL");
        assertEquals(1, tasks.size());
    ...
    public void FIXME_testTaskSingleAndGroupActors() throws Exception {
        ...
        List<TaskSummary> tasks = getClient().getTasksAssignedAsPotentialOwner("Darth Vader", groupIds, "es_CL");
    ...
    public void testTaskAbortNotSkippable() throws Exception {
        ...
        tasks = getClient().getTasksAssignedAsPotentialOwner("Darth Vader", "es_CL");
        assertEquals(1, tasks.size());
    }
    ...
    public void TODOtestOnAllSubTasksEndParentEndStrategy() throws Exception {
        ...
        List<TaskSummary> subTasks = getClient().getSubTasksAssignedAsPotentialOwner(parentTask.getId(), "Darth Vader", "es_CL");
