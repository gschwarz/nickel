...
//    }
    ...
    public void testRemoveNotInRecipientList() {
        ...
        List<TaskSummary> myRecipientTasks = client.getTasksAssignedAsRecipient(users.get("jabba").getId(), "es_CL");
        ...
        List<TaskSummary> myPotentialTasks = client.getTasksAssignedAsPotentialOwner(users.get("jabba").getId(), "es_CL");
