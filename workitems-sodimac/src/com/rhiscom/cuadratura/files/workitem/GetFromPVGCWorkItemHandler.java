...
public class GetFromPVGCWorkItemHandler implements WorkItemHandler {
	SimpleDateFormat formatter = new SimpleDateFormat("yyyyMMdd");
	private final static Logger logger = Logger.getLogger(GetFromPVGCWorkItemHandler.class.getName());
	private StatefulKnowledgeSession session;
	public GetFromPVGCWorkItemHandler(StatefulKnowledgeSession ksession) {
		session=ksession;
	}
