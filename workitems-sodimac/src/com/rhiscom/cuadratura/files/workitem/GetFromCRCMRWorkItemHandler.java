...
public class GetFromCRCMRWorkItemHandler  implements WorkItemHandler  {

	private final static Logger logger = Logger.getLogger(GetFromCRCMRWorkItemHandler.class.getName()); 
	SimpleDateFormat formatter = new SimpleDateFormat("yyyyMMdd");
	private StatefulKnowledgeSession session;
	public GetFromCRCMRWorkItemHandler(StatefulKnowledgeSession ksession) {
		session=ksession;
	}
