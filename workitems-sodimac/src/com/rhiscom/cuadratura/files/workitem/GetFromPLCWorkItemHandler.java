...
public class GetFromPLCWorkItemHandler implements WorkItemHandler {
	SimpleDateFormat formatter = new SimpleDateFormat("yyyyMMdd");
	private final static Logger logger = Logger.getLogger(GetFromPLCWorkItemHandler.class.getName());
	private StatefulKnowledgeSession session;
	public GetFromPLCWorkItemHandler(StatefulKnowledgeSession ksession) {
		session=ksession;
	}
