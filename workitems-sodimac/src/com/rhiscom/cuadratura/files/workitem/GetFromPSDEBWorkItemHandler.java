...
public class GetFromPSDEBWorkItemHandler implements WorkItemHandler {
	SimpleDateFormat formatter = new SimpleDateFormat("yyyyMMdd");
	private final static Logger logger = Logger.getLogger(GetFromPSDEBWorkItemHandler.class.getName());
	private StatefulKnowledgeSession session;
	public GetFromPSDEBWorkItemHandler(StatefulKnowledgeSession ksession) {
		session=ksession;
	}
