...
public class GetFromPLCUAWorkItemHandler implements WorkItemHandler {
	SimpleDateFormat formatter = new SimpleDateFormat("yyyyMMdd");
	private final static Logger logger = Logger.getLogger(GetFromPLCUAWorkItemHandler.class.getName());
	private StatefulKnowledgeSession session;
	public GetFromPLCUAWorkItemHandler(StatefulKnowledgeSession ksession) {
		session=ksession;
	}
