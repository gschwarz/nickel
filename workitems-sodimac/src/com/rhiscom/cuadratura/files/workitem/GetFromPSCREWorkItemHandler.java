...
public class GetFromPSCREWorkItemHandler implements WorkItemHandler {
	SimpleDateFormat formatter = new SimpleDateFormat("yyyyMMdd");
	private final static Logger logger = Logger.getLogger(GetFromPSCREWorkItemHandler.class.getName());
	private StatefulKnowledgeSession session;
	public GetFromPSCREWorkItemHandler(StatefulKnowledgeSession ksession) {
		session=ksession;
	}
