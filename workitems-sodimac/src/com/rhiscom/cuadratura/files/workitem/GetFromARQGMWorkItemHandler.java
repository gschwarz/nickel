...
public class GetFromARQGMWorkItemHandler implements WorkItemHandler {
	SimpleDateFormat formatter = new SimpleDateFormat("yyyyMMdd");
	private final static Logger logger = Logger.getLogger(GetFromARQGMWorkItemHandler.class.getName());
	private StatefulKnowledgeSession session;
	public GetFromARQGMWorkItemHandler(StatefulKnowledgeSession ksession) {
		session=ksession;
	}
