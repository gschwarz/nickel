...
public class GetFromRSATWorkItemHandler implements WorkItemHandler {
	SimpleDateFormat formatter = new SimpleDateFormat("yyyyMMdd");
	private final static Logger logger = Logger.getLogger(GetFromRSATWorkItemHandler.class.getName());
	private StatefulKnowledgeSession session;

	public GetFromRSATWorkItemHandler(StatefulKnowledgeSession ksession) {
		session = ksession;
	}
	...
	public void executeWorkItem(WorkItem workItem, WorkItemManager arg1) {
		Map<String, Object> parameters = workItem.getParameters();
		 System.out.println("BusinessDate :" +  parameters.get("businessDate"));
		...
		List<String> listadoFechas =manager.getFechas();
