...
public class GetFromPLGCWorkItemHandler implements WorkItemHandler {
	SimpleDateFormat formatter = new SimpleDateFormat("yyyyMMdd");
	private final static Logger logger = Logger.getLogger(GetFromPLGCWorkItemHandler.class.getName());
	private StatefulKnowledgeSession session;
	public GetFromPLGCWorkItemHandler(StatefulKnowledgeSession ksession) {
		session=ksession;
	}
