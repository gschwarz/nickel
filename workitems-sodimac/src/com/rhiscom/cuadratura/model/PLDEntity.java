...
@Entity
@Table(name = "file_pld")
public class PLDEntity  implements Serializable {
	@Id
	@TableGenerator(name = "appSeqStore", table = "APP_SEQ_STORE", pkColumnName = "APP_SEQ_NAME", pkColumnValue = "pa_pld.id", valueColumnName = "APP_SEQ_VALUE", initialValue = 1, allocationSize = 1)
