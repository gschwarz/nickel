...
public class CuadraturaAvanceSuperAvanceEntity {

	@Id
	@TableGenerator(name = "appSeqStore", table = "APP_SEQ_STORE", pkColumnName = "APP_SEQ_NAME", pkColumnValue = "cuad_avancesuperavance.id", valueColumnName = "APP_SEQ_VALUE", initialValue = 1, allocationSize = 1)
