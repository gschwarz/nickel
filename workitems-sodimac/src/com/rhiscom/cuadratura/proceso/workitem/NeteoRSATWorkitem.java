...
import com.rhiscom.cuadratura.proceso.manager.NeteoRSATManager;

public class NeteoRSATWorkitem implements WorkItemHandler {
	SimpleDateFormat formatter = new SimpleDateFormat("yyyyMMdd");
	private StatefulKnowledgeSession session;

	public NeteoRSATWorkitem(StatefulKnowledgeSession ksession) {
		session = ksession;
	}
	...
	public void executeWorkItem(WorkItem workItem, WorkItemManager workItemManager) {
		...
		NeteoRSATManager manager = new NeteoRSATManager();

		try {
			manager.NetearRSAT(fechaNegocio, sucursal);
		} catch (Exception e) {
