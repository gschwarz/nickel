...
public class CuadraturaTarjetaDebitoWorkItem implements WorkItemHandler {

	SimpleDateFormat formatter = new SimpleDateFormat("yyyyMMdd");

	private StatefulKnowledgeSession session;

	public CuadraturaTarjetaDebitoWorkItem(StatefulKnowledgeSession ksession) {
		session = ksession;
	}
	...
	public void executeWorkItem(WorkItem workItem, WorkItemManager workItemManager) {
		...
		System.out.println(":: CUADRATURA TARJETA DEBITO ::");
		...
		try {
			...
			e.printStackTrace();
			insertEvent("ERROR_CUADRATURA", e.getMessage() ,"TARJETA DEBITO");
		}
