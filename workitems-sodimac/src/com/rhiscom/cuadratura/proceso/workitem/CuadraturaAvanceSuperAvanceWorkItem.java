...
public class CuadraturaAvanceSuperAvanceWorkItem implements WorkItemHandler {
	SimpleDateFormat formatter = new SimpleDateFormat("yyyyMMdd");
	private StatefulKnowledgeSession session;

	public CuadraturaAvanceSuperAvanceWorkItem(StatefulKnowledgeSession ksession) {
		session = ksession;
	}
	...
	public void executeWorkItem(WorkItem workItem, WorkItemManager workItemManager) {
		...
		System.out.println(":: CUADRATURA AVANCE SUPER AVANCE ::" + fechaNegocio + " - " + sucursal);
		...
		try {
			...
			insertEvent("ERROR_CUADRATURA", e.getMessage() ,"AVANCE SUPER AVANCE");

		}
		
		System.out.println(":: TERMINO CUADRATURA AVANCE SUPER AVANCE ::");
