...
public class ProcessConsoleCellTableActivity extends AbstractActivity implements
	ProcessConsoleCellTableView.Presenter {

    // Used to obtain views, eventBus, placeController
    // Alternatively, could be injected via GIN
    private ClientFactory clientFactory;

    public ProcessConsoleCellTableActivity(ProcessConsoleCellTablePlace place, ClientFactory clientFactory) {
	...
	ProcessConsoleCellTableView processConsoleCellTableView = clientFactory.getProcessConsoleCellTableView();
