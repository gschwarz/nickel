...
@Entity
@Table(name = "file_rsat")
public class RSATEntity {

	@Id
	@TableGenerator(name = "appSeqStore", table = "APP_SEQ_STORE", pkColumnName = "APP_SEQ_NAME", pkColumnValue = "file_rsat.id", valueColumnName = "APP_SEQ_VALUE", initialValue = 1, allocationSize = 1)
	...
	public void setFechaTrx(java.util.Date fechaTrx) {
		this.fechaTrx = new Date(fechaTrx.getTime());
	}
