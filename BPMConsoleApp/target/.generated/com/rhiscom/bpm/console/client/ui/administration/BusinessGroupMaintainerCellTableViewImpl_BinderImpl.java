...
public class BusinessGroupMaintainerCellTableViewImpl_BinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, com.rhiscom.bpm.console.client.ui.administration.BusinessGroupMaintainerCellTableViewImpl>, com.rhiscom.bpm.console.client.ui.administration.BusinessGroupMaintainerCellTableViewImpl.Binder {
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final com.rhiscom.bpm.console.client.ui.administration.BusinessGroupMaintainerCellTableViewImpl owner) {

    com.rhiscom.bpm.console.client.ui.administration.BusinessGroupMaintainerCellTableViewImpl_BinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (com.rhiscom.bpm.console.client.ui.administration.BusinessGroupMaintainerCellTableViewImpl_BinderImpl_GenBundle) GWT.create(com.rhiscom.bpm.console.client.ui.administration.BusinessGroupMaintainerCellTableViewImpl_BinderImpl_GenBundle.class);
    ...
    com.rhiscom.bpm.console.client.ui.administration.BusinessGroupMaintainerCellTableViewImpl_BinderImpl_GenCss_style style = clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay.style();
    ...
    com.google.gwt.user.client.ui.ListBox nivelListBox = owner.nivelListBox;
    ...
    com.google.gwt.user.cellview.client.CellTable cellTableBusinessGroup = owner.cellTableBusinessGroup;
    ...
    com.google.gwt.user.client.ui.HTMLPanel htmlPanel = new com.google.gwt.user.client.ui.HTMLPanel(template.html1("" + i18n.businessGroupTitle() + "", domId0, domId1, domId2, domId3).asString());
    ...
    f_Label3.setDirection(com.google.gwt.i18n.client.HasDirection.Direction.LTR);
    ...
    f_Label4.setWidth("44px");
    f_Label4.setText("" + i18n.level() + " :");
    ...
    nivelListBox.setVisibleItemCount(1);
    f_HorizontalPanel2.add(nivelListBox);
    f_HorizontalPanel2.setStyleName("" + style.rightHorizontalPanel() + "");
    f_HorizontalPanel2.setWidth("100%");
    f_HorizontalPanel2.setHeight("30");
    cellTableBusinessGroup.addStyleName("" + style.cellTable() + "");
    cellTableBusinessGroup.setPageSize(12);
    f_ScrollPanel5.add(cellTableBusinessGroup);
