...
public class SimplePager_Resources_es_CL_InlineClientBundleGenerator implements com.google.gwt.user.cellview.client.SimplePager.Resources {
  private static SimplePager_Resources_es_CL_InlineClientBundleGenerator _instance0 = new SimplePager_Resources_es_CL_InlineClientBundleGenerator();
  ...
  private void simplePagerStyleInitializer() {
    simplePagerStyle = new com.google.gwt.user.cellview.client.SimplePager.Style() {
      ...
      public String getText() {
        return (".MLH{padding:" + ("4px"+ " " +"8px")  + ";text-align:" + ("center")  + ";}.MJH{padding:" + ("4px")  + ";cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.MKH{cursor:" + ("default")  + ";}");
      }
