...
public class CellTree_Resources_en_StaticClientBundleGenerator implements com.google.gwt.user.cellview.client.CellTree.Resources {
  private static CellTree_Resources_en_StaticClientBundleGenerator _instance0 = new CellTree_Resources_en_StaticClientBundleGenerator();
  ...
  private void cellTreeStyleInitializer() {
    cellTreeStyle = new com.google.gwt.user.cellview.client.CellTree.Style() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".MEF{padding-right:" + ("16px")  + ";font-style:" + ("italic")  + ";}.MFF{padding-top:" + ("4px")  + ";padding-bottom:" + ("4px")  + ";cursor:" + ("hand")  + ";cursor:" + ("pointer")  + ";zoom:" + ("1")  + ";}.MHF{zoom:" + ("1")  + ";}.MIF{padding-right:" + ("3px")  + ";padding-left:" + ("3px")  + ";outline:") + (("none")  + ";}.MNF{font-weight:" + ("bold")  + ";color:" + ("#4b4a4a")  + ";margin-top:" + ("20px")  + ";padding:" + ("3px"+ " " +"10px"+ " " +"3px"+ " " +"13px")  + " !important;}.MPF{border-bottom:" + ("1px"+ " " +"solid"+ " " +"#6f7277")  + ";padding-bottom:" + ("1px")  + ";}.MJF{background-color:" + ("#ffc")  + ";outline:" + ("none")  + ";}.MLF{height:" + ((CellTree_Resources_en_StaticClientBundleGenerator.this.cellTreeSelectedBackground()).getHeight() + "px")  + ";overflow:" + ("hidden") ) + (";background:" + ("url(\"" + (CellTree_Resources_en_StaticClientBundleGenerator.this.cellTreeSelectedBackground()).getSafeUri().asString() + "\") -" + (CellTree_Resources_en_StaticClientBundleGenerator.this.cellTreeSelectedBackground()).getLeft() + "px -" + (CellTree_Resources_en_StaticClientBundleGenerator.this.cellTreeSelectedBackground()).getTop() + "px  repeat-x")  + ";background-color:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("visible")  + ";}.MMF{padding-right:" + ("16px")  + ";outline:" + ("none")  + ";}")) : ((".MEF{padding-left:" + ("16px")  + ";font-style:" + ("italic")  + ";}.MFF{padding-top:" + ("4px")  + ";padding-bottom:" + ("4px")  + ";cursor:" + ("hand")  + ";cursor:" + ("pointer")  + ";zoom:" + ("1")  + ";}.MHF{zoom:" + ("1")  + ";}.MIF{padding-left:" + ("3px")  + ";padding-right:" + ("3px")  + ";outline:") + (("none")  + ";}.MNF{font-weight:" + ("bold")  + ";color:" + ("#4b4a4a")  + ";margin-top:" + ("20px")  + ";padding:" + ("3px"+ " " +"13px"+ " " +"3px"+ " " +"10px")  + " !important;}.MPF{border-bottom:" + ("1px"+ " " +"solid"+ " " +"#6f7277")  + ";padding-bottom:" + ("1px")  + ";}.MJF{background-color:" + ("#ffc")  + ";outline:" + ("none")  + ";}.MLF{height:" + ((CellTree_Resources_en_StaticClientBundleGenerator.this.cellTreeSelectedBackground()).getHeight() + "px")  + ";overflow:" + ("hidden") ) + (";background:" + ("url(\"" + (CellTree_Resources_en_StaticClientBundleGenerator.this.cellTreeSelectedBackground()).getSafeUri().asString() + "\") -" + (CellTree_Resources_en_StaticClientBundleGenerator.this.cellTreeSelectedBackground()).getLeft() + "px -" + (CellTree_Resources_en_StaticClientBundleGenerator.this.cellTreeSelectedBackground()).getTop() + "px  repeat-x")  + ";background-color:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("visible")  + ";}.MMF{padding-left:" + ("16px")  + ";outline:" + ("none")  + ";}"));
      }
