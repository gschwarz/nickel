...
public class DragAndDropCellTable_Resources_default_InlineClientBundleGenerator implements gwtquery.plugins.droppable.client.gwt.DragAndDropCellTable.Resources {
  private static DragAndDropCellTable_Resources_default_InlineClientBundleGenerator _instance0 = new DragAndDropCellTable_Resources_default_InlineClientBundleGenerator();
  ...
  private void cellTableStyleInitializer() {
    cellTableStyle = new com.google.gwt.user.cellview.client.CellTable.Style() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".MED{border-top:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("right")  + ";color:" + ("#4b4a4a")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.MFD{border-bottom:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("right")  + ";color:" + ("#4b4a4a")  + ";text-shadow:") + (("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.MOC>div{padding:" + ("2px"+ " " +"15px")  + ";overflow:" + ("hidden")  + ";}.MDE{cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.MDE:hover{color:" + ("#6c6b6b")  + ";}.MPC{background:" + ("#fff")  + ";}.MAD{border:" + ("2px"+ " " +"solid"+ " " +"#fff")  + ";}.MPD{background:" + ("#f3f7fb")  + ";}.MAE{border:" + ("2px"+ " " +"solid"+ " " +"#f3f7fb") ) + (";}.MGD{background:" + ("#eee")  + ";}.MHD{border:" + ("2px"+ " " +"solid"+ " " +"#eee")  + ";}.MJD{background:" + ("#ffc")  + ";}.MKD{border:" + ("2px"+ " " +"solid"+ " " +"#ffc")  + ";}.MBE{background:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("auto")  + ";}.MCE{border:" + ("2px"+ " " +"solid"+ " " +"#628cd5")  + ";}.MID{border:" + ("2px"+ " " +"solid"+ " " +"#d7dde8")  + ";}.MOD{height:") + (((DragAndDropCellTable_Resources_default_InlineClientBundleGenerator.this.cellTableLoading()).getHeight() + "px")  + ";width:" + ((DragAndDropCellTable_Resources_default_InlineClientBundleGenerator.this.cellTableLoading()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (DragAndDropCellTable_Resources_default_InlineClientBundleGenerator.this.cellTableLoading()).getSafeUri().asString() + "\") -" + (DragAndDropCellTable_Resources_default_InlineClientBundleGenerator.this.cellTableLoading()).getLeft() + "px -" + (DragAndDropCellTable_Resources_default_InlineClientBundleGenerator.this.cellTableLoading()).getTop() + "px  no-repeat")  + ";margin:" + ("30px")  + ";}")) : ((".MED{border-top:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("left")  + ";color:" + ("#4b4a4a")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.MFD{border-bottom:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("left")  + ";color:" + ("#4b4a4a")  + ";text-shadow:") + (("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.MOC>div{padding:" + ("2px"+ " " +"15px")  + ";overflow:" + ("hidden")  + ";}.MDE{cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.MDE:hover{color:" + ("#6c6b6b")  + ";}.MPC{background:" + ("#fff")  + ";}.MAD{border:" + ("2px"+ " " +"solid"+ " " +"#fff")  + ";}.MPD{background:" + ("#f3f7fb")  + ";}.MAE{border:" + ("2px"+ " " +"solid"+ " " +"#f3f7fb") ) + (";}.MGD{background:" + ("#eee")  + ";}.MHD{border:" + ("2px"+ " " +"solid"+ " " +"#eee")  + ";}.MJD{background:" + ("#ffc")  + ";}.MKD{border:" + ("2px"+ " " +"solid"+ " " +"#ffc")  + ";}.MBE{background:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("auto")  + ";}.MCE{border:" + ("2px"+ " " +"solid"+ " " +"#628cd5")  + ";}.MID{border:" + ("2px"+ " " +"solid"+ " " +"#d7dde8")  + ";}.MOD{height:") + (((DragAndDropCellTable_Resources_default_InlineClientBundleGenerator.this.cellTableLoading()).getHeight() + "px")  + ";width:" + ((DragAndDropCellTable_Resources_default_InlineClientBundleGenerator.this.cellTableLoading()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (DragAndDropCellTable_Resources_default_InlineClientBundleGenerator.this.cellTableLoading()).getSafeUri().asString() + "\") -" + (DragAndDropCellTable_Resources_default_InlineClientBundleGenerator.this.cellTableLoading()).getLeft() + "px -" + (DragAndDropCellTable_Resources_default_InlineClientBundleGenerator.this.cellTableLoading()).getTop() + "px  no-repeat")  + ";margin:" + ("30px")  + ";}"));
      }
